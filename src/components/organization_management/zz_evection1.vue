      ...
      <el-table :data="tableData" style="width: 100%">
        ...
        <el-table-column label="状态"   >
          <template #default="scope">
            <span v-if="scope.row.deptState===1">禁用</span>
            <span v-if="scope.row.deptState===0">启用</span>
          </template>
        </el-table-column>
<!--      <template #default>
        <span v-if=""></span>
        ...
        <el-table-column prop="operate" label="操作" >
          <template #default="scope">
            ...
            <el-button type="text" size="small" style="color:darkorange" @click="dialogVisible11=true, deptStaff={deptId:tableData[scope.$index].deptId,deptName:tableData[scope.$index].deptName,staffId: tableData[scope.$index].staffId,deptState:tableData[scope.$index].deptState }">修改
            </el-button>
    ...
    <el-drawer v-model="dialogVisible11" title="I am the title" :with-header="false">
      <el-form ref="form" :model="deptStaff" label-width="120px">
        <el-form-item label="部门名称：">
          <el-input v-model="deptStaff.deptName"></el-input>
        </el-form-item>
        <el-form-item label="部门负责人：">

          <el-select v-model="deptStaff.staffId" placeholder="请选择部门负责人">
            <el-option
        ...
        <el-radio-group v-model="deptStaff.deptState">
          <el-radio :label="0">启用</el-radio>
          <el-radio :label="1">禁用</el-radio>
        </el-radio-group>
          aa{{this.deptStaff.staffId}}
        </el-form-item>
        <span class="dialog-footer">
