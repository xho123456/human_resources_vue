  ...
  <div class="saas-main-content">
    <div class="j-card j-card-bordered mainContent">
      <div class="j-card-body">
        ...
        <div class="inputs">
          方案名称：&nbsp;
          <el-input size="mini" v-model="scenarioName" placeholder="输入方案名称"/>
        </div>
        <!-- 标题 -->
          ...
          <el-table :data="social_tableData" max-height="464" style="width: 100%">
            ...
            <el-table-column  label="缴纳项目" width="150">
              <template #default="scope">
                <el-select size="mini" v-model="scope.row.payment_name" filterable placeholder="Select">
                  <el-option
        ...
        <!-- 公积金方案设置，表单 -->
        <div class="input" style="margin-bottom: 22px;">
          <el-table :data="accumulation_tableData" max-height="236" style="width: 100%">
            ...
            <el-table-column label="操作" width="100">
              <template #default="scope">
                <el-button style="color: red" @click.prevent="deleteRow(scope.$index, accumulation_tableData)" type="text" size="small">
                  <i class="iconfont"  style="font-size: 13px;color: red">&#xe61c</i>
                  删除
                </el-button>
              </template>
