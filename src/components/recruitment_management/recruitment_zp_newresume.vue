    ...
    <div class="ant-spin-nested-loading">
      <div class="ant-spin-container">
        <div class="mt-20 ml-20 mr-20">
          ...
          >
            <template #append>
              <el-button @click="beckselectAllnew()">搜索</el-button>
            </template>
          </el-input>
    ...
    <div class="ant-table-wrapper j_statistics_layout">
        ...
        <el-table-column fixed="right" label="操作" width="150">
          <template #default="scope">
            <div style="width: 120px">
              <el-button style="padding-right: 7px" type="text" size="small" @click="update_1(tableData[scope.$index].resumeId)">
                设为候选人
              </el-button>
              <el-dropdown trigger="click">
                ...
                <template #dropdown>
                  <el-dropdown-menu>
                    ...
                    <el-dropdown-item @click="remarks=true,elremarksId=tableData[scope.$index].resumeId">填写备注
                    </el-dropdown-item>
      ...
      <div class="demo-pagination-block">
        <el-pagination
            ...
            :pager-count="5"
            background
            @size-change="beckselectAllnew()"
            @current-change="beckselectAllnew()"
        >
        </el-pagination>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    beckselectAllnew(){
      this.axios({
        url: " http://localhost:8007/provider/resume/selectAllnew",
        method: "post",
        data: {
