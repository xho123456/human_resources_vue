    ...
    <div class="ant-spin-nested-loading">
      <div class="ant-spin-container">
        <div class="mt-20 ml-20 mr-20">
          ...
          >
            <template #append>
              <el-button @click="beckselectAll()">搜索</el-button>
            </template>
          </el-input>
      ...
      <div class="icon-s" v-show="icons">
        <el-row :gutter="10">
          ...
          <el-col :span="1.8">
            <el-button type="primary" @click="beckselectAll()" size="mini">确定</el-button>
          </el-col>
    ...
    <div class="ant-table-wrapper j_statistics_layout">
        ...
        <el-table-column fixed="right" label="操作" width="130">
          <template #default="scope">
            <div style="width: 120px">
              <el-button style="padding-right: 7px" type="text" size="small" v-if="tableData[scope.$index].resumeZt==0"
                         @click="update_1(tableData[scope.$index].resumeId)">
                设为候选人
              </el-button>
      ...
      <div class="demo-pagination-block">
        <el-pagination
            ...
            :pager-count="5"
            background
            @size-change="beckselectAll()"
            @current-change="beckselectAll()"
        >
        </el-pagination>
      </div>
    </div>
...
export default {
  ...
  methods: {
      ...
      beckselectAll() {
        this.axios({
          url: "http://localhost:8007/provider/resume/selectAll",
          method: "post",
          data: {
