            ...
            <li @click="liback(1)">
              <div v-bind:class="{active:isActive1}">
                <router-link :to="{path:this.one,query:{path:this.$route.query.path}}">
                  <span v-bind:class="{sactive:isActive1}">考勤记录</span>
                </router-link>
              </div>
            </li>
            ...
            <li @click="liback(2)">
              <div v-bind:class="{active:isActive2}">
                <router-link :to="{path:this.two,query:{path:this.$route.query.path}}">
                  <span v-bind:class="{sactive:isActive2}">考勤月报表</span>
                </router-link>
              </div>
            </li>
            ...
            <li  @click="liback(3)">
              <div v-bind:class="{active:isActive3}">
                <router-link :to="{path:this.three,query:{path:this.$route.query.path}}">
                  <span v-bind:class="{sactive:isActive3}">历史归档</span>
                </router-link>
              </div>
            </li>
...
export default {
  data(){
    return{
      ...
      isActive3:false,
      //路由地址
      one:'/yyx/statistics/record',
      two:'/yyx/statistics/report',
      three:'/yyx/statistics/archive',
