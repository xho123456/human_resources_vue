      ...
      <div style="padding: 20px; display: flex;">
        ...
        <div style=" margin-left: 10px;">
          <div style="padding: 10px;">
            <p style="margin-bottom: 5px; font-size:24px;font-weight: bold;">您好，蛇颖欣，祝您工作顺利 !</p>
