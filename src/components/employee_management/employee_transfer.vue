    ...
    <div class="j-card j-card-bordered mainContent">
      <div class="j-card-body">
        ...
        <div style="width:100%;height: 100px;position: relative  ">
          <button @click="changesadd=!changesadd" type="button" class="ant-btn ant-btn-primary" style="position: absolute;left:20px;top:30px;">
          ...
          <el-row style="width: 200px;position: absolute;left:1090px;top:30px;">
            <el-input v-model.number="seek" placeholder="搜索" @change="selecttransfer(this.seek)">
        ...
        <div class="sub-Content__primary">
          <el-table :data="tableData" stripe style="width: 100%">
            <el-table-column prop="staffName" fixed label="姓名" width="180" />
            ...
            <el-table-column prop="transferstate" label="状态" width="150" >
              <template #default="scope">
                <span v-if="scope.row.transferstate==0">不同意</span>
                <span v-if="scope.row.transferstate==1">同意</span>
              </template>
            </el-table-column>
          </el-table>
        </div>
      ...
      <div class="demo-pagination-block">
        <el-pagination
            ...
            :pager-count="5"
            background
            @size-change="selecttransfer(this.seek)"
            @current-change="selecttransfer(this.seek)"
        >
        </el-pagination>
      </div>
      ...
      tableData: [
        {
          ...
          staffName: "周奇1",
          takeeffectdate: null,
          transferafterpostname: "法务经理",
          transferrawpostname: "员工",
          transferstate: 0,
          transfertype:"调岗",
          updateddeptname: "销售部",
        },
  ...
  methods: {
    selecttransfer(like){
      if(Object.prototype.toString.call(like)===Object.prototype.toString.call(null)){
        var _this = this;
        _this.axios.get(
            "http://localhost:8007/provider/staff/transfer", {
        ...
        this.axios({
          method:'post',
          url:"http://localhost:8007/provider/staff/transfer/getId",
          data:this.pageInfo,
          responseType:'json',
        ...
        this.axios({
          method:'post',
          url:"http://localhost:8007/provider/staff/transfer/likename",
          data:this.pageInfo,
          responseType:'json',
          responseEncoding:'utf-8',
        }).then((response)=>{
